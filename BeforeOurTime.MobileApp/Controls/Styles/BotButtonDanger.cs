...
namespace BeforeOurTime.MobileApp.Controls
{
    ...
    /// <example>
    /// </example>
    public class BotButtonDanger : Button
    {
        /// <summary>
        ...
        public static readonly BindableProperty ServicesProperty = BindableProperty.Create(
            nameof(Services), typeof(IContainer), typeof(BotButtonDanger), null,
            propertyChanged: (BindableObject bindable, object oldvalue, object newvalue) =>
            {
                var control = (BotButtonDanger)bindable;
        ...
        public void ApplyStyle()
        {
            try
            {
                var button = StyleService.GetTemplate()?.ButtonDanger;
